...
CONFIG = {
    ...
    'overlap_confidence_boost': -5,  # Lower threshold during best hours
...
class UltimateTradingBot:
    ...
    def can_trade(self):
        ...
        logger.info("[DEBUG] can_trade: ALL CHECKS PASSED OK")
        return True
    ...
    def run_cycle(self):
        ...
        logger.info("[DEBUG] About to analyze symbols...")
        logger.info(f"[DEBUG] Number of symbols: {len(self.config['symbols'])}")
        logger.info(f"[DEBUG] First 5: {self.config['symbols'][:5]}")
        ...
        logger.info(f"[DEBUG] Finished analyzing all symbols")
