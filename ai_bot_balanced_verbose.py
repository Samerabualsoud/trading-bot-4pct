...
CONFIG = {
    ...
    'tier1_min_confidence': 55,  # LOWERED for more signals  # OPTIMIZED: Lower threshold for peak hours (was 70)
    'tier2_min_confidence': 60,  # LOWERED for more signals  # OPTIMIZED: Lower threshold for peak hours (was 75)
    'tier3_min_confidence': 65,  # LOWERED for more signals  # OPTIMIZED: Lower threshold for peak hours (was 80)
    ...
    'overlap_confidence_boost': -10,  # More aggressive during best hours  # Lower threshold during best hours
